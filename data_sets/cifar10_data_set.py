...
class CIFAR10:
    ...
    @staticmethod
    def get_input_shape():
        return CIFAR10.image_width, CIFAR10.image_height, CIFAR10.image_channels
    ...
    def get_random_training_subset(subset_size, random_seed):
        ...
        return CIFAR10.get_random_subset(subset_size, random_seed, x_train, y_train)
    ...
    def get_random_testing_subset(subset_size, random_seed):
        ...
        return CIFAR10.get_random_subset(subset_size, random_seed, x_test, y_test)
