...
class ExperimentOnBatchesRunner:
    ...
    def run_experiment(experiment_obj=None, experiment_save_file_path=None):
        ...
        opt = keras.optimizers.sgd(lr=experiment_obj.learning_rate)
    ...
    def create_default_experiment_obj():
        ...
        data_set = DataSetOptions.CIFAR100
        random_seed = 4
        learning_rate = 0.01
        mini_batch_size = 128
        num_epochs = 1
...
def main():
    ...
    ExperimentOnBatchesRunner.run_experiment(experiment_obj=experiment, experiment_save_file_path='./')
